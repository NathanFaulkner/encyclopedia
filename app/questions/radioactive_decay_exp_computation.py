...
class RadioactiveDecayExpComputation(Question):
    def __init__(self, **kwargs):
        ...
        self.format_answer = '\\({ans:.4f}\\) {mass_unit:~}'.format(ans=self.answer, mass_unit=self.mass_unit)
    ...
    name = 'Radioactive Decay: Exponential Computation Problem'
    module_name = 'radioactive_decay_exp_computation'
...
Question_Class = RadioactiveDecayExpComputation
