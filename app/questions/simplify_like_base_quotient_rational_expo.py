...
class SimplifyLikeBaseQuotientRationalExpo(Question):
    """
    """
    ...
    name = 'Simplify Quotient of Exponential Terms with Like Bases'
    module_name = 'simplify_like_base_quotient_rational_expo'
...
Question_Class = SimplifyLikeBaseQuotientRationalExpo
