...
class SimplifyLikeBaseProductRationalExpo(Question):
    """
    """
    def __init__(self, **kwargs):
        ...
        expr = f'{base}^{{ {sy.latex(sy.Rational(p1,q1))} }} \\cdot {base}^{{ {sy.latex(sy.Rational(p2,q2))} }}'
    ...
    name = 'Simplify Product of Exponential Terms with Like Bases'
    module_name = 'simplify_like_base_product_rational_expo'
...
Question_Class = SimplifyLikeBaseProductRationalExpo
